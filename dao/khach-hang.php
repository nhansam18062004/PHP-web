...
// function sinhvien($hovaten, $ngaysinh, $diem){
//     $sql = "INSERT INTO thanhvien(hovaten, ngaysinh, diem) VALUES (?, ?, ?)";
//     pdo_execute($sql,$hovaten, $ngaysinh, $diem);
// }
